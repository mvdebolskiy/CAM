...
subroutine microp_driver_tend(state, ptend, dtime, tskin, pbuf)
   ...
   real(r8),            intent(in)    :: tskin(:)       ! Radiative  surface temperature
   ...
   case ('MG')
      ...
      call micro_mg_cam_tend(state, ptend, dtime, tskin, pbuf)
