...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,671) = .025_r8*rxt(k,509)*y(k,140) + .025_r8*rxt(k,507)*y(k,144) &
                      + .025_r8*rxt(k,508)*y(k,200)
         mat(k,716) = .150_r8*rxt(k,506)*y(k,140) + .150_r8*rxt(k,505)*y(k,200)
         mat(k,1732) = .025_r8*rxt(k,509)*y(k,116) + .150_r8*rxt(k,506)*y(k,127)
         mat(k,1635) = .025_r8*rxt(k,507)*y(k,116)
         mat(k,1433) = .114_r8*rxt(k,469)*y(k,88) + .025_r8*rxt(k,508)*y(k,116) &
